...
(function () {
    ...
    function standardizeText(e, m) {
        ...
        // Temporarily restore the transform tag (will get nuked in domToDoc, but useful for debugging)
        //e.setAttribute('transform', 'rotate(' + theta*180/Math.PI + ') scale(' + scale_x + ',' + scale_y + ')');
